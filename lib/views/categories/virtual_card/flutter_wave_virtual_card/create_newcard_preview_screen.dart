...
class CreateNewCardPreviewScreen extends StatelessWidget {
  ...
  final cardController = Get.put(CreateCardController());
  ...
  _amountWidget(BuildContext context) {
    var data = cardController.cardChargesModel.data;

    return previewAmount(
        amount: "${controller.cardAmountTextController.text} ${data.baseCurr}");
  }

  _amountInformationWidget(BuildContext context) {
    var data = cardController.cardChargesModel.data;
    var _cardCharge = data.cardCharge;
    double amount = double.parse(controller.cardAmountTextController.text);
    ...
    return amountInformationWidget(
      ...
      enterAmountRow:
          "${controller.cardAmountTextController.text} ${data.baseCurr}",
