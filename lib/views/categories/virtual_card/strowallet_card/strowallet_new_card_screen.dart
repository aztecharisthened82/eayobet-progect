...
class CrateStrowalletScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print(controller.strowalletCardCreateInfo.data.customerKycStatus);
    return Obx(
      () => Scaffold(
  ...
  _bodyWidget(BuildContext context) {
    ...
    var baseCur = controller.dashboardController.dashBoardModel.data.baseCurr;
    ...
    return ListView(
      ...
      children: [
        if (data.customerExistStatus == false) ...[
          ...
          limitWidget(
            fee:
                "${controller.dashboardController.fixedCharge.value} ${baseCur} + ${controller.dashboardController.percentCharge.value} %",
            limit:
                "${controller.dashboardController.limitMin.value} ${baseCur} - ${controller.dashboardController.limitMax.value} ${baseCur}",
          ),
  ...
  _customerCreate(BuildContext context) {
    return Visibility(
      visible:
          controller.strowalletCardModel.data.user.strowalletCustomer == "" ||
              controller.strowalletCardModel.data.user.strowalletCustomer ==
                  null
          ? true
          : false,
