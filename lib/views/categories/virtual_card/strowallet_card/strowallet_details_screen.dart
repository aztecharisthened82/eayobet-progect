        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              DetailsRowWidget(
                variable: Strings.billingCountry,
                value: Strings.unitedState,
              ),
              DetailsRowWidget(
                variable: Strings.billingCity,
                value: Strings.miami,
              ),
              DetailsRowWidget(
                variable: Strings.billingStreet,
                value: Strings.miamiAv,
              ),
              DetailsRowWidget(
                variable: Strings.billingZipCode,
                value: Strings.billingZipCode33127,
              ),
              Row(
