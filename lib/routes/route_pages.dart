import 'package:stripcard/views/categories/deposit/bkash_webview_screen.dart';
import 'package:stripcard/views/gift_card/gif_card_preview_screen.dart';
import '../bindings/dashboard_binding.dart';
import '../views/2fa/enable_2fa_screen.dart';
import '../views/2fa/two_fa_otp_screen.dart';
import '../views/categories/virtual_card/cardyfie_card/cardyfie_add_fund/cardyfie_add_fund_screen.dart';
import '../views/categories/virtual_card/cardyfie_card/cardyfie_add_fund/preview_screen.dart';
...
import '../views/categories/virtual_card/cardyfie_card/cardyfie_withdraw/widget/withdraw_preview_screen.dart';
import '../views/categories/virtual_card/stripe_card/strip_card_preview.dart';
...
import '../views/drawer/settings_screen.dart';
...
class RoutePageList {
  static var list = [
    ...
    GetPage(
      name: Routes.gifCardPreviewScreen,
      page: () => GifCardPreviewScreen(),
    ),
    ...
    GetPage(name: Routes.depositScreen, page: () => DepositScreen()),
    GetPage(
    ...
    //!profile screen
    GetPage(name: Routes.mygiftCardScreen, page: () => MyCardScreen()),
    GetPage(
    ...
    GetPage(name: Routes.webPaymentScreen, page: () => WebPaymentScreen()),

    GetPage(name: Routes.kycScreen, page: () => KycScreen()),
    ...
    //money out
    GetPage(name: Routes.moneyOutScreen, page: () => MoneyOutScreen()),
    GetPage(
    ...
    GetPage(name: Routes.stripCardPreview, page: () => StripCardPreview()),
    ...
    GetPage(name: Routes.createNewScreen, page: () => CreateNewScreen()),
    GetPage(name: Routes.settingsScreen, page: () => SettingsScreen()),
    GetPage(name: Routes.addFundScreen, page: () => AddFundScreen()),
    ...
    GetPage(
      name: Routes.addFundCardyfiePreviewScreen,
      page: () => AddFundCardyfiePreviewScreen(),
    ),
    ...
    GetPage(
      name: Routes.cardyfieWithdrawPreviewScreen,
      page: () => CardyfieWithdrawPreviewScreen(),
    ),
  ];
}
